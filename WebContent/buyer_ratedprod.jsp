...
%>	  
				  <div>   
				    <div class="alert alert-success text-center" role="alert"><p>You haven't rated any products yet.</p></div>
				  </div>
...
%>		
					<div class="col-sm-4 col-lg-4 col-md-4">
						<div class="thumbnail">
							<img src=<%=request.getContextPath() + "/images/" + rated.get(i).getPicture()%>
