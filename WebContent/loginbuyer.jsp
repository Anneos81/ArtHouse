                     ...
                     <div class="form-group">
                               ...
                               <label for="inputEmail3" class="col-sm-2 control-label"></label>
                                       ...
                                       <div class="col-sm-10">
                                               ...
                                               <h3 align="center"><strong>Login as Buyer</strong></h3>

                                               <hr>

                                                 <p>

                                                 <% if((request.getAttribute("msg")== null)&&(request.getParameter("mymsg") == null)) { %>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-offset-2 col-sm-10">          
                                       ...
                                       <button type="submit" class="btn btn-default">Login</button>     or      <strong><a href="registerbuyer.jsp">Register</a></strong>
