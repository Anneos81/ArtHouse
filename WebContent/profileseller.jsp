...
%>	
				...
				<div class="col-sm-4 col-lg-4 col-md-4">
						<div class="thumbnail">
						<img src=<%=request.getContextPath() + "/images/" + prodlist.get(i).getPicture()%>
						 alt="" style="width: 320px; height: 200px;">
							...
							<div style="text-align:center">
								<p  align="center" !important ><a href="edititem.jsp?id=<%=prodlist.get(i).getProduct_id() %>" class="btn btn-warning" 
								role="button" style="width:84px;" position="absolute"  top="50%;" left="50%;"> <span class="glyphicon glyphicon-pencil"  aria-hidden="true"></span> Edit</a>
								</p>
								
								<form method="POST" action="delete">
									<input type="hidden" name="pid" value="<%=prodlist.get(i).getProduct_id() %>">	
	  		 	 					 
	  		 	 				   <p  align="center" !important ><button onclick="myFunction()" type="submit" class="btn btn-danger"
	  		 	 				     style="width:84px; position="absolute"  top="50%;" left="50%;">
