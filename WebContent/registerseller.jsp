     ...
     <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9 login">
            	<br> <br> <br>
		        <form class="form-horizontal"  method="post" enctype="multipart/form-data" action="registerSeller">
		        <div class="form-group">
		         <label class="col-sm-2 control-label"></label>
		        
		        <div class="col-sm-6">
		        <h3 align="center"><strong>Register as Seller</strong></h3><hr>
				<p>Please fill the following fields to register</p>
		         ...
		         <div class="form-group">
		            ...
		            <div class="col-sm-6">
		              <input type="text" class="form-control" name="firstname" placeholder="Name" autofocus required>
		            </div>
		          </div>
		           <div class="form-group">
		          ...
		          <div class="form-group">
		            <label class="col-sm-2 control-label">Upload Photo</label>
			            <div class="col-sm-6">
							 <input type="text" class="form-control" placeholder="enter photo name" name="name">
