					 ...
					 <div class="thumbnail">
						 <div class="row">
				            <div class="col-md-5 col-sm-6">
				                <img class="img-responsive" src="<%=request.getContextPath() + "/images/" +  basket.get(i).getPicture()%>"
				                alt="" style="width: 320px; height: 210px;">
				            </div>
		 ...
		 <% 			
				...
				<div class="row">
					...
					<form method="POST" action="removefromCart">
						...
						<button type="submit" class="btn btn-default" aria-label="Left Align" name="cart" value="" width="130px">
						 Empty your Cart   
						</button>
					</form>
					<form action="homepage.jsp">
						<button type="submit" class="btn btn-default" aria-label="Left Align" width="130px">Buy more</button>
				    </form>  
					<%} %>
					</div> <!-- /.col 9 -->
				</div>
