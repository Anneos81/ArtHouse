...
if(session.getAttribute("user-object")=="buyer") {
...
<br> <br> <br>    
                 <div class="col-xs-12 col-md-8 login">
			        ...
			        <form class="form-horizontal" method="post" action="loginSeller">
			          <div class="form-group">
			          <label for="inputEmail3" class="col-sm-2 control-label"></label>

                                       <div class="col-sm-10">

                                               <h3 align="center"><strong>Login as Seller</strong></h3>
                                               ...
                                               <hr>
                                                 ...
                                                 <div><% if(request.getAttribute("msg") != null) { %>      
			            ...
			            <div class="col-sm-10">
			              <input type="text" class="form-control" id="inputEmail3" name="username" placeholder="Username" autofocus>
			            </div>
			          </div>
			          <div class="form-group">
			            <label for="inputPassword3" class="col-sm-2 control-label">Password</label>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-offset-2 col-sm-10">          
                                       ...
                                       <button type="submit" class="btn btn-default">Login</button>     or      <strong><a href="registerseller.jsp">Register</a></strong>
