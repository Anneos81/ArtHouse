            			 ...
            			 <div class="row">
								...
								<form class="form-horizontal" method="post" action="update">
          		 	 				<label class="col-sm-4 control-label"></label>
          		 	 				 <div class="col-sm-8">
          		 	 					 <p><img src="<%=request.getContextPath() + "/images/" + product.getPicture()%>"  alt="something's wrong" style="width: 350px; height: 200px;" name="thisorderid"></p>
          							</div>
								            ...
								            <div class="col-sm-8">
          		 	 							<input type="number" class="form-control" name="pprice" min="0" max="1000" value="<%=product.getPrice() %>" placeholder="price of your painting..">
								            </div>
								        </div>
          		 	 					<div class="form-group">
