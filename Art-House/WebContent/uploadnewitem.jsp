          		 	 		...
          		 	 		<div class="col-sm-8 col-lg-8 col-md-8" align="center">
 								...
 								<form class="form-horizontal" method="post" action="upload"> 
								           ...
								           <div class="col-sm-8">
								            <div class="row">
								            	<div class="col-sm-6">
								            	    <input type="text" class="form-control" name="ppicture"  placeholder="url http://.." required>
								            ...
								            <div class="col-sm-8">
          		 	 							<input type="text" class="form-control" name="pprice"  placeholder="price of your painting.." required>
								            </div>
								        </div>
          		 	 					<div class="form-group">
								            <label class="col-sm-4 control-label">Category</label>
								            <div class="col-sm-8">
          		 	 							<input type="text" class="form-control" name="pcategory"  placeholder="choose category.." required>
								            </div>
								        </div>
          		 	 					<div class="form-group">
